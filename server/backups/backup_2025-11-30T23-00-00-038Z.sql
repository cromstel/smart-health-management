...
CREATE TABLE `accounts` (
  ...
  KEY `idx_type` (`type`),
  KEY `idx_accounts_type_parent` (`type`,`parent_id`),
...
CREATE TABLE `appointments` (
  ...
  KEY `idx_appointments_dept_date_time` (`department_id`,`appointment_date`,`appointment_time`),
...
CREATE TABLE `documents` (
  ...
  KEY `idx_documents_storage_type` (`storage_type`),
...
CREATE TABLE `invoices` (
  ...
  KEY `idx_invoices_status_date` (`status`,`date`),
...
CREATE TABLE `medical_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  KEY `idx_medical_history_diagnosis_date` (`diagnosis_date`),
...
CREATE TABLE `medicine_batches` (
  ...
  KEY `idx_medicine_batches_expiry_date` (`expiry_date`),
  KEY `idx_medicine_batches_recalled` (`recalled`),
...
CREATE TABLE `patients` (
  ...
  KEY `idx_status` (`status`),
  KEY `hospital_id` (`hospital_id`),
  KEY `idx_patients_last_visit` (`last_visit`),
...
CREATE TABLE `prescriptions` (
  ...
  KEY `idx_prescriptions_medicine_id` (`medicine_id`),
...
CREATE TABLE `transactions` (
  ...
  KEY `idx_date` (`date`),
  KEY `idx_transactions_date_account` (`date`,`account_id`),
...
-- Dump completed on 2025-12-01  0:00:00
