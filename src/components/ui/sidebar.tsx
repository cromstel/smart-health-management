  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ transition: 'width 0.3s ease-in-out, min-width 0.3s ease-in-out' }}
        className={cn(
      ...
      <div
        ...
        style={{ transition: 'width 0.3s ease-in-out, left 0.3s ease-in-out, right 0.3s ease-in-out' }}
        className={cn(
